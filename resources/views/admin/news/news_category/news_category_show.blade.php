        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>News Categories <small>News Category for bloging </small></h3>
                </div>
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @include('admin.news.news_category.category-form')
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                                ...
                                @if(count($category))
                                    @foreach($category as $categories)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.newsCategory.edit', ['id'=>$categories->id] ) }}" class="btn btn-primary btn-xs"
                                                    <i class="fa fa-pencil" aria-hidden="true"></i> Edit
                                                </a>


                                                <a href="{{ route('admin.newsCategory.destroy', ['id'=>$categories->id]) }}" class="btn btn-danger btn-xs"
