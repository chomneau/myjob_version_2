        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>All Preferred Degree <small>setting</small></h3>
                </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <a href="#" id="addCategory" class="btn btn-success" data-toggle="modal" data-target="#add-category">
                                Add new preferred degree
                                <i class="glyphicon glyphicon-plus-sign"></i>
                            </a>
                            @include('admin.preferred_degree.degree-form')
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    <th style="width: 1%">#</th>
                                    <th style="width: 20%">Preferred degree</th>
                                    <th>by admin_id</th>
                                    <th>updated_at</th>
                                    ...
                                    @foreach($degree as $degrees)
                                        <tr>
                                            ...
                                            <td id="dataItem" data-toggle="modal" data-target="#editCategory">
                                                <input type="hidden" id="itemId" value="{{ $degrees->id }}">
                                                {{ $degrees->name }}
                                                {{--<br />--}}
                                            ...
                                            <td>
                                                <a href="{{ route('degree.edit', ['id'=>$degrees->id] ) }}" class="btn btn-primary btn-xs"
                                                    <i class="fa fa-pencil" aria-hidden="true"></i> Edit
                                                </a>


                                                <a href="{{ route('degree.delete', ['id'=>$degrees->id]) }}" class="btn btn-danger btn-xs"
                                                   id="confirmation">
