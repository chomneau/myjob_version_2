...
@section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="row">
                <form role="form" class="form-group" action="{{ route('admin.createUserProfile  ', ['id'=>Auth()->user()->id]) }}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="panel col-md-8 col-md-offset-2">
                        ...
                        <div class="col-md-12 {{ $errors->has('password') ? ' has-error' : '' }}" style="margin-bottom: 20px">
                            ...
                            <input type="text" name="username" class="form-control" value="{{ old('password') }}" required autofocus placeholder="Current password" >
