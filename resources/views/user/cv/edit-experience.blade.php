@include('layouts.sectionstyle')
        ...
        <div class="well bs-component">
            <div class="bootstrap-iso">
                <form action="{{ route('mycv.update', ['id'=>$experience->id ]) }}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <fieldset>
                    <legend>EDIT PROFILE</legend>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="position" value="{{ $experience->job_position }}" class="form-control" id="inputDefault" placeholder="position" required autofocus>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="lastName">Employer Name (Exp: Toyota co.,ltd)</label>
                                <input type="text" name="employer_name" value="{{ $experience->company_name }}" class="form-control" id="inputDefault" required autofocus placeholder="company / organization">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::selectMonth('start_month', $experience->start_month, array('class'=>'form-control')) !!}
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group {{ $errors->has('start_year') ? ' has-error' : '' }}">
                                        ...
                                        {!! Form::selectRange('start_year', 2030, 1950, $experience->start_year, array('class'=>'form-control', 'required autofocus')) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::selectMonth('end_month', $experience->end_month, array('class'=>'form-control')) !!}
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::selectRange('end_year', 2030, 1950, $experience->end_year, array('class'=>'form-control', 'required autofocus')) !!}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <textarea class="form-control" rows="9" name="description" id="textArea">{{ $experience->description }}</textarea>
